...
\centering
    ...
    \begin{subfigure}[H]{0.99\textwidth}  
        ...
        \label{fig:uk2se}
    \end{subfigure}
    \caption{Heat-map of the predicted value $\hat{r}_{\vect{x}_0}$ on a grid $(0,315)\times(0,315)$ with second order expectation function. Heat-map of the predicted variance $\sigma_{\hat{r}_{\vect{x}_0}}$ on a grid $(0,315)\times(0,315)$ with second order expectation function.}
\end{figure}
