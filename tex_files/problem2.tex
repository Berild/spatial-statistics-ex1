\paragraph{a)}
We have 52 observations contained in the domain $\mathcal{D} = (0,315)x(0,315)$. In \ref{fig:terrain2a} we see a non-stationary RF, based on the fact that the mean changes with the position of reference. 
...
\begin{figure}[htb]
    ...
    \caption{Heat-map of the predicted value $\hat{r}_{\vect{x}_0}$ on a grid $(0,315)x(0,315)$.}
    \label{fig:uk2}
\end{figure}
...
\begin{figure}[htb]
    ...
    \caption{Heat-map of the predicted variance $\sigma_{\hat{r}_{\vect{x}_0}}$ on a grid $(0,315)x(0,315)$ with a second order .}
    \label{fig:uk2se}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{d)}
